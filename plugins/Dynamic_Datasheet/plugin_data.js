...
/* // old working version of setCustomer
    setCustomer: function(o){
            var l = obj.keys(o).length;
            var p = plugin_data.customer.length;
            for (var i=0; i<l; i++) {
                console.log(i + '/' + l);
                console.log(o[i]);
                plugin_data.customer[p+i] = o[i];
            }
            return plugin_data.customer;
            // return plugin_data.customer = extend(false, plugin_data.customer, o);
        }
*/
...
// function pluginData(name){
    ...
    this.fn = {
        ...
        getCustomer: function(i){
            // db.select()
            return plugin_data.customer[i];
        },
        setCustomer: function(o){
            // var l = obj.keys(o).length;
            /*var p = plugin_data.customer.length;
            for (var i in o) {
                plugin_data.customer[p+Number(i)] = o[i];
            }
            return plugin_data.customer;*/
            
            // db.insert()
            plugin_data.customer = plugin_data.customer.concat(o);
            return plugin_data.customer;
...
// test class models
// console.log(Asiakas1.fn.getCustomer(1));
...
console.log(Asiakas1.fn.getAll());
// test prototype
